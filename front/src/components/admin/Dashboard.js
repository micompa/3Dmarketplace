        ...
        <Fragment>
            <div className="row">
                ...
                <div className="col-12 col-md-10">
                    <h3 className="my-4">Información de la tienda</h3>
                        ...
                        <Fragment>
                            ...
                            <div className="row pr-4">
                                <div className="col-xl-12 col-sm-12 mb-3">
                                    <div className="card text-light bg-success o-hidden h-100">
                            ...
                            <div className="row pr-4">
                                <div className="col-xl-3 col-sm-6 mb-3">
                                    <div className="card text-light bg-primary o-hidden h-100">
                                        <div className="card-body">
